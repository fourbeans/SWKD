...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        # return out
        return self.spike2(out) # [T, B, C, H, W]
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, zero_init_residual=False,
        ...
        self.transform1 = Feature_Converter(channel[1])
        self.transform2 = Feature_Converter(channel[2])
        self.transform3 = Feature_Converter(channel[3])
...
def resnet19_lif(pretrained=False, progress=True, **kwargs):
