...
def main():
    ...
    parser = argparse.ArgumentParser(description='Classify CIFAR100')
    ...
    parser.add_argument('-T', default=0, type=int, help='number of time-steps')
    ...
    if args.method == 'ann_resnet19':
        net = resnet19_ann(num_classes=100)
    elif args.method == 'lif_resnet19':
        print('use resnet19_lif')
        net = resnet19_lif(num_classes=100, T=args.T)
    ...
    import pandas as pd
    from CIFAR100_C import Cifar100_C
    data_csv = {'DataName': ['cifa100_c', 'cifa100_c', 'cifa100_c', 'cifa100_c', 'cifa100_c']}
    ...
    for distortion in distortions:
        ...
        for severity in severities:
            test_data = Cifar100_C(root=r'/zjh/data/CIFAR_100_C', distor=distortion, severity=severity,
                                  transform=transform_test)
